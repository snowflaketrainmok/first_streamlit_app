...
except URLError as e:  #streamlit.write('The user entered ', fruit_choice)
  streamlit.error()
...
# Allow the end user to add a fruit to teh list
add_my_fruit = streamlit.text_input('Waht fruit would you like to add?','jackfruit')
